...
const mentors: Mentor[] = [
  {
    ...
    rating: 4.9,
    reviews: 124,
    description: 'Ведущий эксперт по React, TypeScript и современной frontend архитектуре. Автор 15+ production проектов.',
    avatar: 'АП',
    students: 347,
    successRate: 96,
  ...
  },
  {
    ...
    rating: 5.0,
    reviews: 89,
    description: 'Product Lead с опытом запуска 12+ продуктов. Эксперт по метрикам, аналитике и продуктовой стратегии.',
    avatar: 'МС',
    students: 256,
    successRate: 100,
    achievements: ['Эксперт года', 'Product Pro', 'Сбер лидер'],
    services: [
      { name: 'Product Strategy Session', price: '8,500 ₽', duration: '90 мин' },
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 156,
    description: 'UX/UI дизайнер с опытом в финтех и e-commerce. Ментор по дизайн-системам и пользовательскому опыту.',
    avatar: 'ЕВ',
    students: 198,
    successRate: 94,
...
const products: Product[] = [
  {
    ...
    rating: 4.9,
    reviews: 1247,
    description: 'Полный курс по современному React с TypeScript, Next.js и реальными проектами для портфолио.',
    image: 'RC',
    discount: 25,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 892,
    description: 'Комплексное изучение анализа данных, машинного обучения и нейронных сетей с практическими проектами.',
    image: 'PY',
    discount: 19,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 634,
    description: 'Интенсивное обучение дизайну интерфейсов с фокусом на современные тренды и реальные кейсы.',
    image: 'UX',
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 756,
    description: 'Полный путь от идеи до запуска продукта: стратегия, метрики, команда и масштабирование.',
    image: 'PM',
    discount: 13,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 1089,
    description: 'Комплексное изучение JavaScript: React, Node.js, базы данных и деплой реальных приложений.',
    image: 'JS',
    discount: 17,
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 423,
    description: 'Изучение DevOps практик: Docker, Kubernetes, AWS, CI/CD и автоматизация развертывания.',
    image: 'DO',
...
const aiTeachers: AITeacher[] = [
  {
    ...
    rating: 4.9,
    reviews: 2156,
    description: 'Персональный ИИ-наставник с адаптивными уроками, проверкой произношения и разговорной практикой 24/7.',
    avatar: 'LB',
    ...
    totalChats: 45000,
    specializations: ['Business English', 'IELTS/TOEFL', 'Разговорный', 'Техническая лексика']
  },
  {
    id: 2,
    name: 'CodeMentor AI',
    ...
    rating: 4.8,
    reviews: 1789,
    description: 'ИИ-наставник по программированию с code review, отладкой кода и архитектурными решениями.',
    avatar: 'CM',
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 1234,
    description: 'Специализированный ИИ для изучения анализа данных, машинного обучения и статистики.',
    avatar: 'DG',
...
const filterOptions = {
  categories: ['Все категории', 'Frontend Development', 'Backend Development', 'Data Science', 'Product Management', 'Design', 'DevOps', 'Mobile Development'],
  levels: ['Все уровни', 'Beginner', 'Intermediate', 'Advanced', 'Expert'],
  prices: ['Любая цена', 'Бесплатно', 'До 10,000 ₽', '10,000-25,000 ₽', '25,000-50,000 ₽', '50,000+ ₽'],
  ratings: ['Все рейтинги', '4.0+ звезд', '4.5+ звезд', '4.7+ звезд', '4.9+ звезд'],
  duration: ['Любая длительность', 'До 4 недель', '4-8 недель', '8-16 недель', '16+ недель']
};
...
export default function App() {
  ...
  const tabs = [
    { id: 'store', label: 'Магазин курсов', icon: ShoppingCart, count: '1,200+' },
      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-8 text-white relative overflow-hidden">
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium opacity-90">Ограниченное предложение</span>
          </div>
          <h2 className="text-3xl font-bold mb-2">Чёрная Пятница: -50% на все курсы</h2>
          <p className="text-lg opacity-90 mb-4">Только до 30 ноября! Не упустите шанс прокачать навыки</p>
          ...
          <div key={product.id} className={`group bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-200 ${viewType === 'list' ? 'flex h-32' : 'h-72'}`}>
              ...
              <div className="absolute top-1 right-1 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <button 
                  ...
                  className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors ${
                    favorites.has(product.id) ? 'bg-red-500 text-white' : 'bg-white/90 text-gray-700 hover:bg-red-500 hover:text-white'
                  }`}
                >
            ...
            <div className={`p-2 flex-1 ${viewType === 'list' ? 'flex flex-col justify-between' : ''}`}>
              ...
              <div className="space-y-1 mb-2">
                ...
                {product.instructor && (
                  <div className="text-xs text-blue-600 font-medium truncate">{product.instructor}</div>
                )}
                ...
                {product.badges && (
                  <div className="flex flex-wrap gap-1">
                    {product.badges.slice(0, 2).map((badge, index) => (
                      <span key={index} className="bg-blue-50 text-blue-700 px-1 py-0.5 rounded text-xs">
                        {badge}
                      </span>
                    ))}
                  </div>
      ...
      <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 rounded-2xl p-8 text-white relative overflow-hidden">
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium opacity-90">Искусственный интеллект</span>
          </div>
          <h2 className="text-3xl font-bold mb-2">ИИ-наставники нового поколения</h2>
          <p className="text-lg opacity-90 mb-4">Персонализированное обучение 24/7 с мгновенной обратной связью</p>
          ...
          <div key={teacher.id} className="group bg-white border border-gray-200 rounded-lg p-3 hover:shadow-lg transition-all duration-200 h-64">
            ...
            <div className="flex gap-2 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 text-sm mb-1 truncate">{teacher.name}</h3>
                <p className="text-gray-600 text-xs truncate">{teacher.subject}</p>
                <div className="flex items-center gap-1 mt-1">
                  <Star className="w-3 h-3 fill-yellow-400 text-yellow-400" />
                  <span className="text-xs font-medium text-gray-900">{teacher.rating}</span>
            ...
            {/* Description */}
            <p className="text-gray-700 text-xs mb-2 line-clamp-2">{teacher.description}</p>

            {/* Stats */}
            <div className="grid grid-cols-2 gap-2 mb-2 py-1 border-t border-gray-100">
              <div className="text-center">
                <div className="text-sm font-medium text-gray-900">{(teacher.totalChats / 1000).toFixed(0)}k</div>
                <div className="text-xs text-gray-500">Чатов</div>
              </div>
              <div className="text-center">
                <div className="text-sm font-medium text-gray-900">{teacher.responseTime}</div>
            ...
            <div className="mt-auto">
              <div className="flex items-center justify-between mb-2">
                <span className="font-bold text-gray-900 text-sm">{teacher.price}</span>
 ...
 const renderMentorsContent = () => (
  <div className="space-y-6">
    ...
    <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 rounded-2xl p-8 text-white relative overflow-hidden">
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-medium opacity-90">Персональное наставничество</span>
        </div>
        <h2 className="text-3xl font-bold mb-2">Эксперты из ведущих компаний</h2>
        <p className="text-lg opacity-90 mb-4">Индивидуальные консультации от практикующих специалистов</p>
        <button className="bg-white text-gray-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
          Найти ментора
        </button>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      {mentors.map((mentor) => (
        <div key={mentor.id} className="group bg-white border border-gray-200 rounded-lg p-3 hover:shadow-lg transition-all duration-200 h-80">
          {/* Badge */}
          {mentor.badge && (
            <div
          ...
          <div className="flex gap-2 mb-2">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-semibold text-gray-900 text-sm mb-1 truncate">{mentor.name}</h3>
              <p className="text-gray-600 text-xs mb-1 truncate">{mentor.title}</p>
              <p className="text-gray-500 text-xs truncate">{mentor.company}</p>
              <div className="flex items-center gap-1 mt-1">
                <Star className="w-3 h-3 fill-yellow-400 text-yellow-400" />
                <span className="text-xs font-medium text-gray-900">{mentor.rating}</span>
          ...
          {/* Description */}
          <p className="text-gray-700 text-xs mb-2 line-clamp-2">{mentor.description}</p>
          ...
          <div className="bg-gray-50 rounded p-2 mb-2 space-y-1">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-medium text-gray-900">{mentor.nextAvailable}</span>
            </div>
            <div className="flex items-center justify-between text-xs">
          ...
          <div className="grid grid-cols-3 gap-2 mb-2 py-1 border-t border-gray-100">
            ...
            <div className="text-center">
              <div className="text-sm font-medium text-gray-900">{mentor.completedSessions}</div>
              <div className="text-xs text-gray-500">Сессий</div>
            </div>
            <div className="text-center">
              <div className="text-sm font-medium text-gray-900">{mentor.successRate}%</div>
          ...
          <div className="bg-gray-50 rounded p-2 mb-3">
            <div className="text-xs font-medium text-gray-900 mb-1">{mentor.services[0].name}</div>
            <div className="flex items-center justify-between">
              <span className="text-sm font-bold text-gray-900">{mentor.services[0].price}</span>
              <span className="text-xs text-gray-500">{mentor.services[0].duration}</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-gray-500 ml-2 hidden sm:inline">Pro</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="relative hidden md:block">
                ...
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                  <kbd className="bg-gray-200 text-gray-500 px-1.5 py-0.5 rounded text-xs font-medium">⌘K</kbd>
                </div>
              </div>
              
              <div className="flex items-center gap-2">
                <button className="px-4 py-2 text-gray-700 font-medium text-sm hover:text-gray-900 transition-colors">
                  Войти
                </button>
                <button className="px-6 py-2.5 bg-blue-600 text-white font-medium text-sm rounded-xl hover:bg-blue-700 transition-all hover:shadow-lg">
                  Начать обучение
                </button>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> нового поколения</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
            Курсы от экспертов, ИИ-наставники 24/7 и персональное менторство для максимально быстрого развития ваших навыков
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                {['Популярное', 'Новое', 'Скидки'].map((filter) => (
                  <button key={filter} className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg text-xs font-medium hover:bg-gray-200 transition-colors">
                    {filter}
                  </button>
                ))}
              </div>
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-500 hidden sm:inline">Вид:</span>
              <div className="flex bg-white border border-gray-200 rounded-lg p-1">
                <button 
                  onClick={() => setViewType('grid')}
                  className={`p-1.5 rounded transition-colors ${viewType === 'grid' ? 'bg-blue-100 text-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                >
                  <Grid className="w-4 h-4" />
                </button>
                <button 
                  onClick={() => setViewType('list')}
                  className={`p-1.5 rounded transition-colors ${viewType === 'list' ? 'bg-blue-100 text-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                >
                  ...
                  return (
                    <div key={key} className="relative">
                      ...
                      <div className="relative">
                        ...
                        >
                          <span className="text-gray-900 truncate">{filters[filterKey] || options[0]}</span>
                          <ChevronDown className={`w-4 h-4 text-gray-400 transition-transform ${openDropdown === key ? 'rotate-180' : ''}`} />
                        </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-bold text-gray-900 text-lg">MentorConnect</span>
              </div>
              <p className="text-gray-600 text-sm leading-relaxed mb-6">
                Платформа нового поколения для ускоренного обучения и профессионального развития.
              </p>
            ...
            {[
              {
                title: 'Обучение',
                links: ['Курсы и программы', 'ИИ-наставники', 'Персональные менторы', 'Корпоративное обучение']
              },
              {
                title: 'Ресурсы',
                links: ['База знаний', 'Блог и статьи', 'Карьерные гиды', 'Истории успеха']
              },
              {
                title: 'Поддержка',
                links: ['Центр помощи', 'Связаться с нами', 'Статус сервиса', 'Обратная связь']
              }
            ].map((column, index) => (
              <div key={index}>
