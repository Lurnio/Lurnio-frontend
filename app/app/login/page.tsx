    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="bg-white rounded-2xl shadow-2xl p-8 border" style={{ borderColor: colors.border }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input 
                    type="checkbox" 
                    className="w-4 h-4 rounded border-2 focus:ring-2 focus:ring-opacity-20 mr-3" 
                    style={{ 
                      borderColor: colors.border,
                      focusRingColor: colors.primary
                    }}
              ...
              <button
                type="submit"
                className="w-full py-4 px-6 rounded-xl font-semibold text-white transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg focus:ring-4 focus:ring-opacity-30"
                style={{ 
                  background: `linear-gradient(135deg, ${colors.primary} 0%, ${colors.accent} 100%)`,
                  focusRingColor: colors.primary
                }}
              ...
              <div className="relative my-8">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t-2" style={{ borderColor: colors.border }}></div>
                </div>
              ...
              <div className="space-y-4">
                ...
                >
                  <MessageCircle size={20} className="mr-3" style={{ color: '#0088CC' }} />
                  Продолжить с Telegram
                </button>
              </div>

              <p className="text-center text-base" style={{ color: colors.textSecondary }}>
                Нет аккаунта?{' '}
                <Link
                  href="/signup"
